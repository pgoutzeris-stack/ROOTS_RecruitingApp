...
const RootsBlock = memo(() => (
  <div style={shared.card}>
    <div style={{ fontSize: theme.font.xs, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.08em', color: theme.colors.accent.indigoMid, marginBottom: theme.spacing.sm }}>
